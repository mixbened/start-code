  ...
  data(){
      return {
          questions: [
              ...
              {title: 'Wer unterrichtet die START.CODE Kurse?', content: 'Die TrainerInnen sind IT-Profis: Sie arbeiten entweder als ProgrammiererInnen oder sind IT-Selbstständige. Sie sind erfahren und können dir Coding beibringen und dir zeigen, wie das Leben einer/s CoderIn aussieht.'},
              ...
              {title: 'Ich habe keine Erfahrung im Programmieren, kann ich trotzdem teilnehmen?', content: 'Unsere Grundlagenkurse sind perfekt für Personen ohne Coding-Background. Schau Dir doch einmal den Kurs Web Development an, dieser ist auf Anfänger ausgerichtet.'},
